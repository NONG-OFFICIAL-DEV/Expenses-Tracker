...
import { ArrowLeft, Pencil, ScaleIcon, Trash2 } from "lucide-react";
...
export default function AccountDetailPage() {
  ...
  if (isLoading || !account) {
    return <p className="py-12 text-center text-sm text-neutral-500">Loading account...</p>;
  }
  ...
  return (
    <div className="flex flex-col gap-6">
      <Link href="/accounts" className="flex items-center gap-1 text-sm text-neutral-500 hover:text-neutral-900">
      ...
      <div className="rounded-xl border border-neutral-200 bg-white p-6">
        ...
        <p className="text-3xl font-semibold">{formatAmount(account.balance, account.currency, account.type)}</p>
        <div className="mt-4">
          <ReconcileDialog
