...
export default function TransactionDetailPage() {
  ...
  if (isLoading || !transaction) {
    return <p className="py-12 text-center text-sm text-neutral-500">Loading transaction...</p>;
  }
  ...
  return (
    <div className="flex flex-col gap-6">
      <Link href="/transactions" className="flex items-center gap-1 text-sm text-neutral-500 hover:text-neutral-900">
