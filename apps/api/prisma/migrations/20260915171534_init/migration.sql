-- CreateEnum
CREATE TYPE "AccountType" AS ENUM ('BANK', 'SAVINGS', 'CASH', 'MOBILE_WALLET', 'CRYPTO', 'INVESTMENT', 'CREDIT_CARD', 'OTHER');
...
CREATE TABLE "Account" (
    ...
    "currency" TEXT NOT NULL DEFAULT 'USD',
    "openingBalance" DECIMAL(20,8) NOT NULL DEFAULT 0,
...
CREATE TABLE "BalanceAdjustment" (
    "id" TEXT NOT NULL,
    "accountId" TEXT NOT NULL,
    "calculatedBalance" DECIMAL(20,8) NOT NULL,
    "actualBalance" DECIMAL(20,8) NOT NULL,
...
-- CreateIndex
CREATE INDEX "BalanceAdjustment_accountId_idx" ON "BalanceAdjustment"("accountId");
